...
const fs = require('fs');
const targetFile = path.resolve(__dirname, `../../node_modules/awesome-typescript-loader/dist/instance.js`);
...
process.stdout.write(`patching ${targetFile}...`);
fs.writeFileSync(targetFile, patch, 'utf8');
